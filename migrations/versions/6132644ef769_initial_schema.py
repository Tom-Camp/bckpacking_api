...
Revision ID: 6132644ef769
Revises:
Create Date: 2026-09-21 18:46:52.712901
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("role", sa.Enum("user", "admin", "unauthenticated", name="userrole"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("measurements", sa.Enum("metric", "imperial", name="unit"), nullable=False),
        sa.Column(
            "trip_type", sa.Enum("loop", "out-and-back", "point-to-point", name="triptype"), nullable=False
        ),
        ...
        sa.Column("permit_details", sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("name", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
        sa.Column(
            "meal_type", sa.Enum("breakfast", "lunch", "dinner", "snack", name="meal"), nullable=False
        ),
        sa.Column("weight", sa.Float(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_table("user")
    # ### end Alembic commands ###
    # Postgres ENUM types aren't dropped by drop_table; remove them explicitly.
    bind = op.get_bind()
    for enum_name in (
        "userstatus",
        "userrole",
